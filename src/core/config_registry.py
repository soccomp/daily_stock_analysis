...
WEB_SETTINGS_HIDDEN_FROM_UI = {
    "DSA_INVESTMENT_CANARY_ACCOUNT_ID",
    "DSA_INVESTMENT_CANARY_ENABLED",
    "DSA_INVESTMENT_CANARY_SYMBOLS",
    "DSA_INVESTMENT_SHADOW_ENABLED",
    "DSA_SINGLE_BRAIN_M2_ACCOUNT_ID",
    "DSA_SINGLE_BRAIN_M2_ENABLED",
    "DSA_SINGLE_BRAIN_M2_CYCLE_GUARD_SECONDS",
    "DSA_SINGLE_BRAIN_M2_HOLDINGS_LIMIT",
    "DSA_SINGLE_BRAIN_M2_INTERVAL_MINUTES",
    "DSA_SINGLE_BRAIN_M2_MAX_SYMBOLS",
    "DSA_SINGLE_BRAIN_M2_NATURAL_SESSION_GATE_ENABLED",
    "DSA_SINGLE_BRAIN_M2_READINESS_GATE_ENABLED",
    "DSA_SINGLE_BRAIN_M2_RISK_POLICY_PATH",
    "DSA_SINGLE_BRAIN_M2_RUN_IMMEDIATELY",
    "DSA_SINGLE_BRAIN_M2_SNAPSHOT_TIMEOUT_SECONDS",
    "DSA_SINGLE_BRAIN_M2_SNAPSHOT_URL",
    "DSA_SINGLE_BRAIN_M2_SYMBOLS",
    "DSA_SINGLE_BRAIN_M2_SCREENING_ENABLED",
    "DSA_SINGLE_BRAIN_M2_SCREENING_MAX_CANDIDATES",
    "DSA_SINGLE_BRAIN_M2_SCREENING_MAX_AGE_HOURS",
    "DSA_SINGLE_BRAIN_EXECUTION_MODE",
    "DSA_SINGLE_BRAIN_SIMULATION_EXECUTION_AUTHORIZED",
    "DSA_SINGLE_BRAIN_M3_EXECUTION_URL",
    "DSA_SINGLE_BRAIN_M3_EXECUTION_TIMEOUT_SECONDS",
    "DSA_SINGLE_BRAIN_M3_EXECUTION_SYMBOLS",
    "DSA_SINGLE_BRAIN_PROPOSAL_SYMBOLS",
    "DSA_SINGLE_BRAIN_PROPOSAL_TIMEOUT_SECONDS",
    "DSA_SINGLE_BRAIN_PROPOSAL_URL",
    "DSA_RESEARCH_MARKET_DATA_HEALTH_TTL_SECONDS",
    "DATABASE_PATH",
    "SQLITE_WAL_ENABLED",
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "CODEX_CLI_MODEL": {
        ...
        "description": "Exact model passed to Codex CLI when GENERATION_BACKEND=codex_cli. Production default is GPT-5.6 Luna.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {"pattern": r"^[^\s|<>;`$]+$"},
        "display_order": 1,
        "help_key": "settings.ai_model.CODEX_CLI_MODEL",
        "examples": ["CODEX_CLI_MODEL=gpt-5.6-luna"],
        "docs": [{"label": "LLM 配置指南", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/LLM_CONFIG_GUIDE.md"}],
        "warning_codes": [],
    },
    "CODEX_CLI_REASONING_EFFORT": {
        "title": "Codex Reasoning Effort",
        "description": "Reasoning effort passed to Codex CLI. Production observation-period default is max.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "max",
        "options": [{"label": value, "value": value} for value in ("none", "low", "medium", "high", "xhigh", "max")],
        "validation": {"enum": ["none", "low", "medium", "high", "xhigh", "max"]},
        "display_order": 1,
        "help_key": "settings.ai_model.CODEX_CLI_REASONING_EFFORT",
        "examples": ["CODEX_CLI_REASONING_EFFORT=max"],
        "docs": [{"label": "LLM 配置指南", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/LLM_CONFIG_GUIDE.md"}],
        "warning_codes": [],
    },
    "CODEX_CLI_WEB_SEARCH_ENABLED": {
        "title": "Codex CLI Web Search",
        "description": "Explicitly enable Codex native live web search. Disabled by default; DSA-provided evidence remains closed by default.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 1,
        "help_key": "settings.ai_model.CODEX_CLI_WEB_SEARCH_ENABLED",
        "examples": ["CODEX_CLI_WEB_SEARCH_ENABLED=false"],
        "docs": [{"label": "LLM 配置指南", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/LLM_CONFIG_GUIDE.md"}],
        "warning_codes": [],
    },
    "GENERATION_FALLBACK_BACKEND": {
        "title": "Fallback Generation Method",
        "description": "Backend-level fallback method. Empty disables backend fallback; Codex production requires this value to remain empty.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "SEARXNG_PUBLIC_INSTANCES_ENABLED": {
        ...
        "description": "Auto-discover public SearXNG instances from searx.space when SEARXNG_BASE_URLS is empty. Default: false; enable only as an explicit fallback opt-in.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
