...
const fieldTitleMap: Record<string, string> = {
  ...
  CODEX_CLI_MODEL: 'Codex CLI 模型',
  CODEX_CLI_REASONING_EFFORT: 'Codex 推理强度',
  CODEX_CLI_WEB_SEARCH_ENABLED: 'Codex 原生联网搜索',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  CODEX_CLI_REASONING_EFFORT: 'Codex CLI 推理强度；生产默认 max，支持 none、low、medium、high、xhigh、max。',
